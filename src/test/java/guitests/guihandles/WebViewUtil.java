...
public class WebViewUtil {
    ...
    /**
     * If the {@code calendarPanelHandle}'s {@code WebView} is loading, sleeps the thread till it is successfully loaded.
     */
    public static void waitUntilBrowserLoaded(CalendarPanelHandle calendarPanelHandle) {
