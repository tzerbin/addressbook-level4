...
public class CommandBoxTest extends GuiUnitTest {
    ...
    private void assertBehaviorForFailedCommand() {
        commandBoxHandle.run(COMMAND_THAT_FAILS);
        assertFalse(((NewResultAvailableEvent) eventsRuleForCollector.eventsCollector.getMostRecent()).successful);
        assertTrue(eventsRuleForCollector.eventsCollector.getSize() == 1);
        eventsRuleForCollector.eventsCollector.reset();
    ...
    private void assertBehaviorForSuccessfulCommand() {
        commandBoxHandle.run(COMMAND_THAT_SUCCEEDS);
        assertTrue(((NewResultAvailableEvent) eventsRuleForCollector.eventsCollector.getMostRecent()).successful);
        assertTrue(eventsRuleForCollector.eventsCollector.getSize() == 1);
        eventsRuleForCollector.eventsCollector.reset();
