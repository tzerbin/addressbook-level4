...
This section describes some noteworthy features that are implemented in Celeb Scheduler.
...
|`* * *` |user | see the best route of travel between two locations |  plan for the shortest travel

|`* * *` |user | know the estimated distance and time of travel between two locations |  plan for my schedules more effectively
