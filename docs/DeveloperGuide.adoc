...
*Distance and time of travel between 2 location*: Able to calculate the distance and time required to travel between two
location to allow the celebrity manager to plan appointments and trips more effectively. (By Damien)
