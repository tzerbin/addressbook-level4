...
Alternatively, you can download the AsciiDoc plugin for IntelliJ, which allows you to preview the changes you've have made to your `.adoc` files in real-time.
