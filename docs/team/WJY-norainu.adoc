...
** What it does: This enhancement includes these commands: viewCalendar, viewCombinedCalendar, viewCalendarBy, and
...
** Highlights: The implementation was challenging as it requires comprehension of CalendarFX's API and experimenting
with the API to understand which methods to be used to update the calendar UI. Also, additional variables were created
...
** What it does: This enhancement refers to the deleteAppointment command. It allows users to delete an existing
appointment.
** Justification: This feature improves the product significantly because users can delete a specified appointment to
indicate the cancellation of appointments and keep the calendar(s) clean and tidy.
** Highlights: This enhancement requires an understanding of how appointments are stored.
** Credits: [http://dlsc.com/wp-content/html/calendarfx/apidocs/index.html[CalendarFX]]
