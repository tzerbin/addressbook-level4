...
Alias: `aa` +
Format: `addAppointment n/APPOINTMENT_NAME [l/LOCATION] [sd/START_DATE] [st/START_TIME] [ed/END_DATE] [et/END_TIME] [c/CELEB_INDEX]...`

Examples:

* `add n/Oscars 2018 l/Hollywood sd/23/03/2018 st/14:00 ed/23/03/2018 et/20:00 c/2 c/4`
* `add n/Dentist Appointment l/Dental Clinic st/15:45 c/1`
...
* You can have zero or more celebrities for whom you want to add this appointment to their calendars with the `c/` fields.
****
...
The following are summarized versions of all the commands introduced above, with their command format and an example
highlighting the usage. An optional field is enclosed within a pair of `[]`. A field that can be repeatedly entered
with different input values is followed by `...`.
...
* *Add Appointment* : `addAppointment n/APPOINTMENT_NAME [l/LOCATION] [sd/START_DATE] [st/START_TIME] [ed/END_DATE] [et/END_TIME] [c/CELEB_INDEX]...` +
